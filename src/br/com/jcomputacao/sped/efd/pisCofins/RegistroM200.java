...
public class RegistroM200 extends LineArchetype implements EfdPisCofinsRegistro{
    ...
    */
    ...
    //05 - Valor Total da Contribuição Não Cumulativa Devida (02 – 03 - 04)
    public static String VL_TOT_CONT_NC_DEV = "VL_TOT_CONT_NC_DEV";
    //06 - Valor Retido na Fonte Deduzido no Período
    public static String VL_RET_NC = "VL_RET_NC";
    //07 - Outras Deduções no Período
    public static String VL_OUT_DED_NC = "VL_OUT_DED_NC";
    //08 - Valor da Contribuição Não Cumulativa a Recolher/Pagar (05 – 06 - 07)
    ...
    //10 - Valor Retido na Fonte Deduzido no Período
    public static String VL_RET_CUM = "VL_RET_CUM";
    //11 - Outras Deduções no Período
    public static String VL_OUT_DED_CUM = "VL_OUT_DED_CUM";
    //12 - Valor da Contribuição Cumulativa a Recolher/Pagar (09 - 10 – 11)
    public static String VL_CONT_CUM_REC = "VL_CONT_CUM_REC";
    //13 - Valor Total da Contribuição a Recolher/Pagar no Período (08 + 12)
    public static String VL_TOT_CONT_REC = "VL_TOT_CONT_REC";
    
    public RegistroM200(){
        setName("Consolidação da contribuição para o Pis/Pasep do período");
        setDelimiter("|");
        ...
        fdm.setFormat(fw);
        //01
        addFieldArchetype(REG, new FieldDefaultArchetype("M200"));
        //02        
