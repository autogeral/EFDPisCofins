...
/**
 * Feb 6, 2013 4:16:17 PM
 * @author Jennifer
 */
public class RegistroC870 extends LineArchetype {
    //01 - Fixo
    ...
    public RegistroC870 (){
        setName("Resumo diário de documentos emitidos por equipamento sat-cf-e (código 59) - Pis/Pasep e Cofins");
        setDelimiter("|");
        ...
        //01
        addFieldArchetype(REG, new FieldDefaultArchetype("C870"));
        //02
