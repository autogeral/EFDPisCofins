 ...
 */
public class RegistroM300 extends LineArchetype implements EfdPisCofinsRegistro {

    public String getNome() {
        return "CONTRIBUIÇÃO DE PIS/PASEP DIFERIDA EM PERÍODOS ANTERIORES – VALORES A PAGAR NO PERÍODO";
    }
    ...
    public RegistroM300(){
        ...
        addFieldArchetype(DT_RECEB, new FieldIntegerMaximumLengthArchetype(8));
    }
}
