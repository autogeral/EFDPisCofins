 ...
 */
public class RegistroM510 extends LineArchetype{
    ...
    //05 - Número do processo, documento ou ato concessório ao qual o ajuste está vinculado, se houver.
    ...
    public RegistroM510(){
        setName("Ajustes do crédito de Cofins apurado");
        setDelimiter("|");
        ...
        //01
        addFieldArchetype(REG, new FieldDefaultArchetype("M510"));
        //02
