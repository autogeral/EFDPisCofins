 ...
 * @author Jennifer
 */
public class RegistroF500 extends LineArchetype {
    //01 - Fixo
    public static String REG = "REG";
    //02 - Valor total da receita recebida, referente à combinação de CST e Alíquota.
    ...
    */
    ...
    public RegistroF500(){
        setName("Consolidação das operações da pessoa jurídica submetida ao regime de tributação com base no lucro presumido - incidência do Pis/Pasep e da Cofins pelo regime de caixa");
        setDelimiter("|");
        ...
        //01
        addFieldArchetype(REG, new FieldDefaultArchetype("F500"));
        //02
