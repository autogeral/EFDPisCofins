 ...
 */
public class RegistroM410 extends LineArchetype{
    ...
    public RegistroM410(){
        setName("Detalhamento das receitas isentas, não alcançadas pela incidência da contribuição, sujeitas a alíquota zero ou vendas com suspensão - Pis/Pasep");
        setDelimiter("|");
