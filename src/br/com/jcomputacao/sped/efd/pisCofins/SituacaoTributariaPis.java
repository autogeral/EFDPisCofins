...
/**
 * Tabela 4.3.3 em http://www1.receita.fazenda.gov.br/sistemas/efd-pis-cofins/tabela-codigos/tabelas-de-codigos.htm
 * 17/11/2011 21:59:03
 * @author Murilo
 */
public enum SituacaoTributariaPis {
    ...
    private SituacaoTributariaPis(int codigo) {
        this.codigo = codigo;
    }
